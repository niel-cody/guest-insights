...
export function ChecksDrawer({ checks }: { checks: Check[] }) {
  ...
  // Every close path restores trigger focus, including the scrim click, which
  // previously did not.
  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        className="inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[12px] font-medium hover:opacity-80 focus-visible:ring-2 focus-visible:ring-accent focus-visible:outline-none"
      ...
      <Drawer
        open={open}
        onClose={close}
        label="The check register"
        eyebrow="What this report is standing on"
        title="The check register"
        width={520}
      >
